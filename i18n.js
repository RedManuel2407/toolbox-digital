...
const TRANSLATIONS = {
    ...
    'qr.desc': { de: 'Erstelle QR-Codes für Links, WiFi, Kontakte und mehr – mit Logo und individuellen Farben.', en: 'Create QR codes for links, WiFi, contacts and more – with logo and custom colors.' },
    'qr.tags.1': { de: 'Generator', en: 'Generator' },
    'qr.tags.2': { de: 'QR-Code', en: 'QR Code' },
    'qr.tab.text': { de: 'Text / URL', en: 'Text / URL' },
    'qr.tab.wifi': { de: 'WiFi', en: 'WiFi' },
    'qr.tab.vcard': { de: 'Kontakt', en: 'Contact' },
    'qr.tab.email': { de: 'E-Mail', en: 'Email' },
    ...
    'qr.fgColor': { de: 'Vordergrund', en: 'Foreground' },
    'qr.bgColor': { de: 'Hintergrund', en: 'Background' },
    'qr.errorLevel': { de: 'Fehlerkorrektur', en: 'Error Correction' },
    'qr.logo': { de: 'Logo / Bild', en: 'Logo / Image' },
    'qr.addLogo': { de: 'Bild hinzufügen', en: 'Add Image' },
    'qr.removeLogo': { de: 'Entfernen', en: 'Remove' },
    ...
    'qr.enterData': { de: 'Daten eingeben...', en: 'Enter data...' },
    // WiFi
    'qr.wifi.name': { de: 'Netzwerkname (SSID)', en: 'Network Name (SSID)' },
    'qr.wifi.namePlaceholder': { de: 'Mein WLAN', en: 'My WiFi' },
    'qr.wifi.password': { de: 'Passwort', en: 'Password' },
    'qr.wifi.passPlaceholder': { de: 'WLAN-Passwort', en: 'WiFi Password' },
    'qr.wifi.encryption': { de: 'Verschlüsselung', en: 'Encryption' },
    'qr.wifi.open': { de: 'Offen (kein Passwort)', en: 'Open (no password)' },
    'qr.wifi.hidden': { de: 'Verstecktes Netzwerk', en: 'Hidden Network' },
    // vCard
    'qr.vcard.firstname': { de: 'Vorname', en: 'First Name' },
    'qr.vcard.lastname': { de: 'Nachname', en: 'Last Name' },
    'qr.vcard.phone': { de: 'Telefon', en: 'Phone' },
    'qr.vcard.email': { de: 'E-Mail', en: 'Email' },
    'qr.vcard.org': { de: 'Firma / Organisation', en: 'Company / Organization' },
    'qr.vcard.orgPlaceholder': { de: 'Firmenname (optional)', en: 'Company name (optional)' },
    'qr.vcard.url': { de: 'Website', en: 'Website' },
    // Email
    'qr.email.to': { de: 'Empfänger', en: 'Recipient' },
    'qr.email.subject': { de: 'Betreff', en: 'Subject' },
    'qr.email.subjectPlaceholder': { de: 'Betreff der E-Mail', en: 'Email subject' },
    'qr.email.body': { de: 'Nachricht', en: 'Message' },
    'qr.email.bodyPlaceholder': { de: 'Nachrichtentext (optional)', en: 'Message body (optional)' },
